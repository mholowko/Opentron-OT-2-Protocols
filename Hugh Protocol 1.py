...
plate2 = labware.load('96-PCR-flat', '5', 'plate2')

tiprack1 = labware.load('tiprack-200ul', '1', 'p200rack')
tiprack2 = labware.load('tiprack-200ul', '4', 'p200rack')
...
pipette.transfer(5, plate2.cols(0,length=12),plate.cols(0,length=12),trash=False,
                 new_tip='always', mix_before=(3,20),mix_after=(3,100))
